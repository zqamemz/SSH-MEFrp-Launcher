...
程序部分功能（登录、签到等）需要人机验证。

1. 程序内会显示验证页面链接
2. 用浏览器打开链接，完成验证
3. 将获取到的 `token` 粘贴回程序输入框

验证页面地址：`https://www.mefrp.com/3rdparty/captcha?client=SML`
